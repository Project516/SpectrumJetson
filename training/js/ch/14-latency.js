...
Site.chapter('latency', (root) => {
  ...
  /* ── Frame timeline ────────────────────────────────────── */
  {
    const S = [
      ...
      { n: 'Decode', ms: 2.6, k: 'm', d: 'The JPEG is turned back into a 1280×800 gray image: about 2.6 ms, on the Jetson\'s NVJPG hardware decoder (or libjpeg-turbo on the CPU). It was 8.9 ms before our fix.' },
      { n: 'GPU detect', ms: 2, k: 'm', d: 'The CUDA detector finds every tag and its four corners on the GPU: about 1.6–2 ms per frame, measured.' },
